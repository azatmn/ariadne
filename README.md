...
| `OSRM_URL` пустой | чистка и дорисовка пропускают трек, предупреждение в лог | осознанная настройка, а не поломка |
...
| дорисовка | `TestGoldenFill_MatchesPrototype` | 13 |
| **весь конвейер: вход → ответ** | `TestGoldenPipe_MatchesPrototype` | 8 |
