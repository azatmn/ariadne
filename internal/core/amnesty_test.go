...
// Четыре входа, на которых оправдывать некого или нечем. Каждый обязан дать
// ПУСТУЮ амнистию, а не панику и не «оправдать всех на всякий случай»:
// амнистия снимает штраф, и лишнее оправдание вернуло бы в цепочку спуфинг.
//
// Случай «нет снэпов вовсе» не выдуманный — так выглядит прогон при молчащем
// OSRM, и именно там соблазн оправдать по одним соседям сильнее всего.
